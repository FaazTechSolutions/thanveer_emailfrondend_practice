...
export default function EmailIntelligenceDashboard() {
  ...
  const fetchEmails = async (isRefresh = false) => {
    try {
      ...
      setError(null);
      const res = await fetch('https://thanveer-emailbackend-practice.onrender.com/mails?limit=10&offset=0');
...
//     setLoading(true);
//     try {
//       const res = await fetch(`https://thanveer-emailbackend-practice.onrender.com/emails?page=${page}&size=${size}`);
